	...
	private final static Preset[] PRESETS = new Preset[] {
			new Preset(new Position[] { new Position(1, 1), new Position(1, 2),
					...
					new Position[] { new Position(1, 1), new Position(1, 2),
							...
							new Position(5, 9), new Position(6, 2),
							new Position(6, 3), new Position(6, 4),
							new Position(6, 5), new Position(6, 6),
							new Position(6, 7), new Position(6, 8),
							new Position(6, 9), new Position(7, 3),
							new Position(7, 4), new Position(7, 5),
							new Position(7, 6), new Position(7, 8),
							new Position(7, 9), new Position(8, 4),
